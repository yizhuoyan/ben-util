 ...
 * @since JDK5.0
 */
public class LinkedStringBuilder implements Appendable, Serializable {
	private final LinkedList<String> linkedList;
	private int charCount = 0;

	public LinkedStringBuilder append(CharSequence csq) {
		return null;
	}

	public LinkedStringBuilder append(CharSequence csq, int start, int end) {
		return null;
	}

	public LinkedStringBuilder append(char c) {
		return null;
	}
	...
	public LinkedStringBuilder(LinkedStringBuilder old) {
		if (old != null) {
	 ...
	 * 
	 * @param obj
	 *            添加的对象，调用toString方法转换为字符串，空则为null
