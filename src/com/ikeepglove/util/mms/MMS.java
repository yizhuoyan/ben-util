...
public class MMS implements MMSConstants, Serializable {
  ...
  private List<MMSAddress> hTo = new ArrayList<MMSAddress>();
  private List<MMSAddress> hCc = new ArrayList<MMSAddress>();
  private List<MMSAddress> hBcc = new ArrayList<MMSAddress>();
  private Date hReceivedDate;
  private MMSAddress hFrom=null;
  ...
  private HashMap<String,MMSContent> tableOfContents=new LinkedHashMap<String, MMSContent>();
  ...
  private MMSAddress decodeAddress(String value) {
    ...
    MMSAddress result = new MMSAddress(address,type);
    return result;
  }
  ...
  public void addToAddress(String value) {
    MMSAddress addr = decodeAddress(value);
    hTo.add(addr);
   ...
   *
   * return a List<MMAddress> of MMAddress objects.
   *
   */
  public List<MMSAddress> getTo() {
    return hTo;
  }
  ...
  public void setFrom(String value) {
    hFrom = new MMSAddress( decodeAddress(value) );
   ...
   *
   */
  public void addContent(MMSContent mmc) {
   ...
   */
  public MMSContent getPresentation() {
    if ((flagMultipartRelated==true) && (getNumContents()>0))
       return (MMSContent) tableOfContents.get(presentationId);
    else
       return null;
  }
   ...
   */
  public MMSContent getContent(String id) {
    return tableOfContents.get(id);
  }
  public List<MMSContent> getContentList(){
	  List<MMSContent> list=new ArrayList<MMSContent>();
	  for (String contentID : tableOfContents.keySet()) {
		  list.add(tableOfContents.get(contentID));
	  }
	  return list;
  }
